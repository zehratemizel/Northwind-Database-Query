...
SELECT unit_price, CONCAT('TR',' ',product_name) AS big_name
FROM products
WHERE unit_price < 20;
...
SELECT categories.category_name , ROUND(AVG(products.unit_price)) AS category_avg
FROM products
JOIN categories
ON products.category_id = categories.category_id
